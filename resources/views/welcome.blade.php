    ...
    <button data-drawer-target="separator-sidebar" data-drawer-toggle="separator-sidebar" aria-controls="separator-sidebar" type="button" class="inline-flex items-center p-2 mt-2 ml-3 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
     ...
     <aside id="separator-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            <div class="pb-4 mb-4 flex flex-col items-center font-medium border-b border-gray-200 dark:border-gray-700">
           ...
           <ul class="space-y-2 font-medium">
            <li>
              ...
              <li>
                 <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                  <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 320 512"><path d="M80 160c0-35.3 28.7-64 64-64h32c35.3 0 64 28.7 64 64v3.6c0 21.8-11.1 42.1-29.4 53.8l-42.2 27.1c-25.2 16.2-40.4 44.1-40.4 74V320c0 17.7 14.3 32 32 32s32-14.3 32-32v-1.4c0-8.2 4.2-15.8 11-20.2l42.2-27.1c36.6-23.6 58.8-64.1 58.8-107.7V160c0-70.7-57.3-128-128-128H144C73.3 32 16 89.3 16 160c0 17.7 14.3 32 32 32s32-14.3 32-32zm80 320a40 40 0 1 0 0-80 40 40 0 1 0 0 80z"/></svg>
     ...
     <div class="sm:ml-64">
       <nav class="bg-white shadow-md w-screen h-12 px-2 flex justify-between items-center">
         ...
         <!--drop down --->
            <div class="rounded-full h-75" style="margin-right:40px;cursor:pointer" id="dropdownInformationButton" data-dropdown-toggle="dropdownInformation">
         ...
         <!-- Dropdown menu -->
         <div id="dropdownInformation" class="z-10 hidden bg-white my-3 divide-gray-100 rounded-lg shadow w-56 dark:bg-gray-700 dark:divide-gray-600">
        ...
        <!---cards articles-->
         <div class="calander" style="margin: 30px;display:flex;justify-content:space-around;align-items:center">
            <span style="font-family: 'Courier New', Courier, monospace;font-size:30px">👋Welcome back <strong>Mohammed</strong>!</span>
           @php
               $calanderHtml=(new  App\Http\Controllers\calander())->calendar();
               echo $calanderHtml;
           @endphp
         </div>
         <div>

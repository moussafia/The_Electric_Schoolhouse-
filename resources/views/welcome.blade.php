...
<link rel="stylesheet" href="{{asset('/assets/css/style.css')}}">
 ...
 <body>  
    ...
    <a href="https://flowbite.com/" class="flex items-center">
        ...
        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white logo-color">E.S.H</span>
    </a>
    <div class="flex md:order-2">
        {{-- log in button  --}}
        <a href="#" class="text-linear-brand
                                    focus:outline-none 
                                    focus:ring-4 
                                    focus:ring-gray-200 
                                    font-medium 
    ...
    <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
        ...
        <li>
            <a href="#" class="block py-2 pl-3 pr-4 text-gray-900 rounded md:bg-transparent md:text-dark-700 md:p-0 md:dark:text-dark hover-text">Partenariats</a>
        </li>
        <li>
            <a href="#" class="block py-2 pl-3 pr-4 text-gray-900 rounded md:bg-transparent md:text-dark-700 md:p-0 md:dark:text-dark hover-text">About</a>
        </li>
      
        <li>
            <a href="#" class="block py-2 pl-3 pr-4 text-gray-900 rounded md:bg-transparent md:text-dark-700 md:p-0 md:dark:text-dark hover-text">Contact</a>
        </li>
        </ul>
    </div>
    </div>
...
<!-- Slider main container -->
    ...
    {{-- partenariat --}}
<div class="h-30" style="height:35vh;box-shadow:0 0 8px #eedfdf; ">
...
{{-- about us --}}
<div class="px-24" style="height:60vh;box-shadow:0 0 8px #eedfdf; ">
...
<footer class="bg-white dark:bg-gray-900 z-10" style="box-shadow:0 0 8px #eedfdf; ">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          ...
          <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0 mr-4">

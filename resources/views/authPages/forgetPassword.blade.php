...
<body id="LogIN-page" class="flex flex-col justify-center items-center">
        ...
        <form action="" class="bg-white flex flex-col rounded-lg shadow-md" style="padding: 30px;width:350px">
            ...
            <button class="flex justify-center bg-linear-brand my-3 w-fit text-white py-1.5 rounded-md">Send</button>

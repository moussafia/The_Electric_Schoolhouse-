...
<div id="modalEditDeleteBlogs" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative w-full max-w-2xl h-full max-h-full overflow-y-auto">
       ...
       <!---confirmation delete blogs -->
       <div id="modalDeleteBlogs" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative w-full max-w-2xl max-h-full">
            <!-- Modal content -->
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-hide="modalDeleteBlogs">
                ...
                <form action="" method="post" id="formDeleteBlog">
                    ...
                    <div>
                        ...
                        <button data-modal-hide="modalDeleteBlogs" type="button" 

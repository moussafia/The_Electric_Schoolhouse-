            ...
            <div class="p-6 space-y-6">
                <form id="formBlogs" method="POST" action="{{route('blog.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="py-6" id="pargraphForms">
                        <div id="row1">
                            <label for="small-input"
                                class="block mb-3 mt-2 text-sm font-medium text-gray-900 dark:text-white">pargaraph
                                1</label>
                            <textarea name="paragraph[]"
                                class="paragraphs w-full block rounded-lg h-56 overflow-x-hidden overflow-y-auto border border-gray-300 bg-gray-50">
                            </textarea>
                        </div>
                    </div>
                    ...
                    <div class="py-4">
                        <label class="block mb-2 font-medium text-gray-900 dark:text-white" style="font-size: 15px"
                            for="multiple_files">Choisir un cover pour votre blogs</label>
                        <input name="image"
                    ...
                    <div class="py-2">
                        ...
                        <select id="categorySelect" name="categories[]" multiple="multiple"
                    ...
                    <div class="py-2">
                        ...
                        <select id="tagSelect" name="tag" multiple="multiple"
                            class="border border-gray-300 rounded-lg bg-gray-50" style="width: 100%">
                    ...
                    <div
                        ...
                        <button data-modal-hide="modalAddArticles" type="button"

            ...
            success: function (response) {
                ...
                <tr class="bg-white border-b dark:bg-gray-800
                 ...
                 data-user-id="${users.id}" id="row${users.id}">
                       ...
                       ${roles.map(role => role.name).join('<br>')}
                       </td>
                   ...
                   $('#tableUsers').find(`[data-user-id="${users.id}"]`).replaceWith(html);                
            }
        });
    })
});
